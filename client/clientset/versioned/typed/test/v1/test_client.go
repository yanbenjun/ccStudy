...
import (
	...
	v1 "github.com/yanbenjun/ccstudy/apis/test/v1"
...
// TestV1Client is used to interact with features provided by the test.github.com group.
type TestV1Client struct {
	restClient rest.Interface
}

func (c *TestV1Client) Students(namespace string) StudentInterface {
